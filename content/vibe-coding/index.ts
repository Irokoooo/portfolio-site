...
export interface VibeCodingPost {
  ...
  highlights?: string[];
  highlightsEn?: string[];
  mediaItems?: { src: string; label: string; labelEn?: string }[];
}
...
export const vibeCodingPosts: VibeCodingPost[] = [
  {
    ...
    titleEn: "Zenow AI Health Companion Game",
    description: "以“心流时间”为命题，把真实健康任务变成掷骰探索、成长反馈与 AI 陪伴体验；在她来创造 Coding Lady 女性 AI 创造者黑客松中获得创意奖。",
    descriptionEn: "A flow-time health game that turns real habits into dice-driven exploration, growth feedback, and AI companionship; winner of the Creativity Award at Coding Lady.",
    date: "2026-07",
    tags: ["AI Companion", "Gamified Health", "Multi-Agent Workflow", "Three.js", "Supabase"],
    type: "Hackathon Product",
    typeEn: "Hackathon Product",
    mediaType: "image",
    sourceFiles: [
  ...
  },
  {
    ...
    titleEn: "SpellBook | OpenClaw Agent Workspace",
    description: "用网页聊天替代传统终端操作的 AI Agent 可视化管理平台，通过 Web 与本地 Agent 双端架构降低 OpenClaw 的使用门槛。",
    descriptionEn: "A visual AI-agent workspace that replaces terminal-heavy OpenClaw workflows with web chat and a coordinated web/local-agent architecture.",
    date: "2026-06",
    tags: ["OpenClaw", "Agent Architecture", "Next.js", "FastAPI", "Supabase Realtime"],
    type: "Product Prototype",
    typeEn: "Product Prototype",
    mediaType: "image",
    sourceFiles: [],
  ...
  },
  {
    ...
    titleEn: "LawFlaw AI Compliance System",
    description: "面向涉外合同合规场景的 AI 助手，打通 Agent 接入、会话管理与结构化结果回传。",
    descriptionEn: "An AI assistant for cross-border contract compliance, connecting agent integration, conversation management, and structured result delivery.",
    date: "2025-10",
  ...
  },
  {
    ...
    titleEn: "Luma Flow Contextual Language Learning Platform",
    description: "抓取实时新闻并按语言能力动态分级，支持同页口语对练，减少语言学习中的语境割裂与切换摩擦。",
    descriptionEn: "A real-time news learning platform with adaptive difficulty and in-page speaking practice, designed to reduce context switching.",
    date: "2026-04",
  ...
  },
  {
    ...
    title: "个人作品集早期版本",
    titleEn: "Early Portfolio Version",
    description: "作品集初版视觉与信息架构探索，用于验证信息分层与页面骨架。",
    descriptionEn: "An early exploration of the portfolio's visual language and information architecture.",
    date: "2025-06",
  ...
  },
  {
    ...
    title: "大学生综测系统设计",
    titleEn: "University Student Evaluation System",
    description: "将综测细则算法化并落地双端审核流，面向班委与学生的校园管理效率系统。",
    descriptionEn: "A campus operations system that translates evaluation rules into algorithms and a two-sided review workflow.",
    date: "2025-09",
  ...
  },
  {
    ...
    titleEn: "APPLE ASSENCE Business Platform",
    description: "围绕洛川苹果助农出海搭建跨国商务销售平台，结合大模型与数字人交互完成商业化验证。",
    descriptionEn: "A cross-border commerce platform for Luochuan apples, combining LLM capabilities and a digital human to validate commercialization.",
    date: "2025-01",
  ...
  },
  {
    ...
    titleEn: "AgriMind Smart Agriculture Collaboration Platform",
    description: "基于田野调研构建科技助农场景原型，验证农业信息可视化与业务协同的可行性。",
    descriptionEn: "A field-research-led prototype validating agricultural information visualization and operational collaboration.",
    date: "2025-04",
