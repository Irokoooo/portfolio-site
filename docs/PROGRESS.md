...
## 第九十一轮：Career 崩溃与子页面路由修复（2026-08-04）

- [x] 修复桌面 Career 双语 metric unit 对象直接渲染导致的 React Runtime Error
- [x] 修复移动端 Career 双语 API 数据兼容与历史乱码
- [x] 补齐 3D 书房地球仪 `globe` → Next Destination 路由
- [x] 排除本地 `Skills/` 目录，恢复项目生产构建
- [x] 浏览器回归桌面中英与手机列表/详情
